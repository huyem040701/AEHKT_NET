...
namespace AEHKT.Areas.Admin.Controllers
{

    public class DashboardController : BaseController
    {
        private AEHKTDbContext db = new AEHKTDbContext();
        // GET: Admin/Dashboard
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.Neworder = db.Orders.Where(m => m.status == 1).Count();
            ViewBag.contact = db.Contacts.Where(m => m.status == 1).Count();
